...
const Banner = () => {
  return (
    <div className="w-full border-b border-gray-200/10 bg-background py-3 pl-4 text-center text-sm font-semibold text-gray-400 transition-colors hover:text-white">
